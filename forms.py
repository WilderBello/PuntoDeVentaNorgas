...
from wtforms import StringField, SubmitField, DateField, EmailField, SelectField, SearchField
...
class Buscar(FlaskForm):
    Cliente = SearchField('Cliente', validators=[DataRequired()], id="buscar_cliente_bd")
